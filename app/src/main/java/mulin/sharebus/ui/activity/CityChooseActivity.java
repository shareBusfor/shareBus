...
import mulin.sharebus.adapter.CityListAdapter;
import mulin.sharebus.db.DBHelper;
import mulin.sharebus.db.DatabaseHelper;
import mulin.sharebus.entity.City;
import mulin.sharebus.ui.fragment.MainLoginFragment;
import mulin.sharebus.ui.view.LetterListView;
import mulin.sharebus.util.DensityUtil;
import mulin.sharebus.util.LogUtils;
import mulin.sharebus.util.PingYinUtil;

public class CityChooseActivity extends SupportActivity implements LetterListView.OnTouchingLetterChangedListener,AbsListView.OnScrollListener{
